    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/30 rounded-xl p-8 border border-blue-200 dark:border-blue-800 shadow-lg hover:shadow-xl transition-shadow duration-300">
        <div className="text-center">
          ...
          {isCurrentlyWorking() && (
            <div className="mb-6">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Working Time</p>
      ...
      {attendanceStats && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/20 dark:to-emerald-900/30 rounded-xl p-6 border border-green-200 dark:border-green-800 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-green-600 dark:text-green-400">
                  of {attendanceStats.totalDays} days
                </p>
              </div>
          ...
          <div className="px-6 py-4 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
              ...
              <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(todayAttendance.status)}`}>
                ...
                <span className="ml-2 capitalize">{todayAttendance.status}</span>
              </div>
            </div>
          </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    {record.clockOut ? (
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-yellow-600 dark:text-yellow-400">Currently working</p>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {record.duration ? `${(record.duration / 60).toFixed(2)} hours` : 'In progress'}
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-bold text-blue-600 dark:text-blue-400">
                  {todayAttendance.totalHours ? `${todayAttendance.totalHours.toFixed(2)} hours` : '0 hours'}
                </span>
              </div>
            </div>
          </div>
