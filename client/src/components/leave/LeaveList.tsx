              ...
              <div className="flex items-start justify-between mb-3">
                ...
                <div>
                  ...
                  <div className="font-medium text-gray-900 dark:text-gray-100">
                    {leave.isHourlyLeave && leave.totalHours 
                      ? `${leave.totalHours} ${t('common.hours')} (${leave.totalDays} ${t('leave.days')})`
                ...
                <div>
                  ...
                  <div className="font-medium text-gray-900 dark:text-gray-100 text-xs">
                    ...
                    {leave.isHourlyLeave && leave.startTime && leave.endTime && (
            ...
            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-600">
              {filteredLeaves.map((leave) => (
                <tr key={leave._id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100 font-medium">
                    {leave.isHourlyLeave && leave.totalHours 
                      ? <span title={`${leave.totalDays} ${t('common.days')}`}>{leave.totalHours}h</span>
                      : leave.totalDays
                    }
                  </td>
