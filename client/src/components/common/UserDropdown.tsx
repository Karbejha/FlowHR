...
export default function UserDropdown() {
  ...
  return (
    <Menu as="div" className="relative ml-3 z-[99999]">
      ...
      >
        <Menu.Items 
          className={`absolute ${isRTL ? 'left-0' : 'right-0'} mt-2 w-48 ${isRTL ? 'origin-top-left' : 'origin-top-right'} rounded-md bg-white py-1 shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-gray-800 border border-gray-200 dark:border-gray-700 z-[99999]`}
        >          <Menu.Item>
            {({ active }) => (
              <Link
                href="/profile"
